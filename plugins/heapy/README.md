...
- Running Java snippets in a tracked JShell process with pid-specific shutdown.
...
- `skills/jshell/SKILL.md` - tracked JShell invocation and pid-specific shutdown.
...
Use the jshell skill to run this Java snippet without leaving an interactive process behind
